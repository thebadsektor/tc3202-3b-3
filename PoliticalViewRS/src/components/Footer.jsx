    ...
    <footer className="bg-[#000000] text-white text-md text-sm">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center pt-3 px-6 mb-5 text-center">
        ...
        <div className="flex flex-col items-center">
          <h3 className="font-bold font-mono text-2xl mb-2 text-white/80">
            Contributors
          </h3>
          <ul className="space-y-1">
            <li>
              <Link
                ...
                className="text-white/70 text-md hover:bg-cyan-300 hover:font-bold hover:text-black px-2 py-1 rounded"
              >
                Junie Antopina
              </Link>
            </li>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4">
            {mainstreamNews.map((news, index) => (
              <a
                ...
                className="text-white/70 text-md hover:text-cyan-300 px-2 py-1"
              >
                {news.name}
              </a>
            ))}
